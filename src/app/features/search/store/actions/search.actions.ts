...
export const sendRequest = createAction("[Fruit Search] Send request", props<Search.requestParams>());
...
export const setPagination = createAction("[Fruit Search] Set pagination", props<{ page?: Search.state['page'], limit?: Search.state["limit"] }>());
